// To parse this data:
//
//   import { Convert, GliphyImages } from "./file";
//
//   const gliphyImages = Convert.toGliphyImages(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface GliphyImage {
  id: string;
  title: string;
  url: string;
  width: string;
...
export interface GliphyResponse {
  data:       GliphyData[];
  pagination: Pagination;
  meta:       Meta;
}

export interface GliphyData {
  type:                       Type;
  id:                         string;
  url:                        string;
  slug:                       string;
...
export class Convert {
  public static toGliphyImages(json: string): GliphyResponse {
    return cast(JSON.parse(json), r("GliphyImages"));
  }

  public static gliphyImagesToJson(value: GliphyResponse): string {
    return JSON.stringify(uncast(value, r("GliphyImages")), null, 2);
  }
}
